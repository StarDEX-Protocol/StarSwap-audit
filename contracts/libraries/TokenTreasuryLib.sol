 ...
 * Main contract of StarSwap contains a withdraw function that is intended to allow owner to collect fees.
 * Treasury is guarding order makers so that the StarSwap owner is not allowed to steal funds from already
 * submitted orders.
 */
