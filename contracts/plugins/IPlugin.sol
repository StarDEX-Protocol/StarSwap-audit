...
/**
 * @notice interface for a StarSwap plugin. It allows to specify a custom logic to run when a significant event
 * occurs during the StarSwap contract lifecycle, i.e. order creation, order fill and order cancellation.
 */
