...
/**
 * @title StarSwapOrderManager
 * @notice Manages the creation and storage of public orders which are represented as ERC721 tokens.
 */
contract StarSwapOrderManager is ERC721, ERC721Enumerable, ERC721Burnable, Ownable {
  uint256 public tokenIdCounter;

  /// tokenId => order data
  mapping(uint256 => PublicOrder) public orders;

  constructor() ERC721('StarSwap order', 'SSO') Ownable(_msgSender()) {}
